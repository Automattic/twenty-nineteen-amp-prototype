...
/**
 * Source: https://github.com/better-studio/amp-menu/blob/master/includes/classes/class-amp-menu-menu-walker.php
 *
 ...
 *    <amp-accordion>
 *      <section>
 *          <h6><li>Submenu 1</li></h6># Parent item with childs
 *          <div>
 *                <a href="#">Submenu 2</a>
 *                ....                      #list sub menus
 *          </div>
 ...
 * @since 1.0.0
 */
class TwentyNineteen_AMP_Menu_Walker extends Walker_Nav_Menu {
	...
	public function end_accordion( &$output, $depth = 0 ) {
		...
		$output .= "</section></amp-accordion></li>";
